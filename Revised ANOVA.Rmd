...
``` {r mass-emmeans}
mass_emm <- emmeans(mass_clmm2, specs = pairwise ~ blooms_level | task, mode = "mean.class")
...
``` {r kinetics-emmeans}
kinetics_emm <- emmeans(kinetics_clmm, specs = pairwise ~ blooms_level | task, mode = "mean.class")

kinetics_emm$emmeans %>%
