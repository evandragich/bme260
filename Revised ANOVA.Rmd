...
clmm(rating ~ blooms_level * task + year + (1 |student_id), data = .)
...
```{r resid-normal}
# mass
qqnorm(residuals(mass_lmm))
qqnorm(residuals(kinetics_lmm))
```

Satisfied, as the above residuals seem to follow the straight line on the QQ plot reasonably.